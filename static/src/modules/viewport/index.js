define(function (require) {
    ...
    var viewport = new Module({
        ...
        viewportHeight: ko.observable(900),
    ...
    component.on("changeBackColor", function (_bc) {
        _viewport.backColor(_bc);
    });
    hierarchy.on("create", function (element, _parent) {
        //暂时预留这个_parent
        _viewport.addElement(element, _parent);
    });
